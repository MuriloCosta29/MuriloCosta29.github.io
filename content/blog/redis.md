...
description: "How I added Redis caching to a FastAPI app using the cache-aside pattern — and the JSON serialization bug that taught me to read the logs."
tags:
  - redis
  - fastapi
  - postgresql
...
I added Redis to Deploy Tracker using the cache-aside pattern. The goal was simple: avoid repeated PostgreSQL queries when the same data was requested multiple times.
